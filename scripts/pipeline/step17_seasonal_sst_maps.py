...
Two output figures, one per season type:
  - step17_sst_t1_maps.png : grid of T1 (primera temporada) maps, one per year
  - step17_sst_t2_maps.png : grid of T2 (segunda temporada) maps, one per year
...
Outputs:
  PLOTS/step17_sst_t1_maps.png
  PLOTS/step17_sst_t2_maps.png
...
# ── main ─────────────────────────────────────────────────────────────────────
def main():
    out_t1 = PLOTS / "step17_sst_t1_maps.png"
    out_t2 = PLOTS / "step17_sst_t2_maps.png"
