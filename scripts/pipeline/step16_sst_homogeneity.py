...
Outputs:
  PLOTS/step16_sst_ridge.png         -- ridge plot by latitude band
  PLOTS/step16_sst_correlations.png  -- pairwise correlation heatmap
...
# ── main ─────────────────────────────────────────────────────────────────────
def main():
    out_ridge = PLOTS / "step16_sst_ridge.png"
    out_corr  = PLOTS / "step16_sst_correlations.png"
