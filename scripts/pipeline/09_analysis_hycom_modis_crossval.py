...
Outputs:
  PLOTS/09_analysis_hycom_modis_crossval.png

Skip logic: skipped if PLOTS/09_analysis_hycom_modis_crossval.png already exists.
"""
import warnings
...
def step0_crossval(SAMPLE_YEAR=2021):
    ...
    plt.tight_layout()
    plt.savefig(PLOTS / "09_analysis_hycom_modis_crossval.png", dpi=120, bbox_inches="tight")
    plt.close()


def main():
    if (PLOTS / "09_analysis_hycom_modis_crossval.png").exists():
        print("09_analysis_hycom_modis_crossval.png exists -- skipping")
        return

    step0_crossval()
    print(f"09_analysis_hycom_modis_crossval.png saved to {PLOTS}")
